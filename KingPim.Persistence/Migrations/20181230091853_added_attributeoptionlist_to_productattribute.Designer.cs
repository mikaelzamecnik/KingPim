...
namespace KingPim.Persistence.Migrations
{
    ...
    [Migration("20181230091853_added_attributeoptionlist_to_productattribute")]
    partial class added_attributeoptionlist_to_productattribute
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KingPim.Domain.Entities.AttributeOptionList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("KingPim.Domain.Entities.SubcategoryAttributeGroup", b =>
                {
                    b.HasOne("KingPim.Domain.Entities.AttributeGroup")
                        .WithMany("Subcategory")
                        .HasForeignKey("AttributeGroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("KingPim.Domain.Entities.SubCategory")
